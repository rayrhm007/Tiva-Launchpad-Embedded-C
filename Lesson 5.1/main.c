...
#define GPIODATA_F *((unsigned int *)0x40025038u)       /*GPIODATA port F register + appropriate offset (0x038) to allow LED data 
...
int main()
{
  ...
  RCGC_GPIO = 0x20u;       //u to indicate unsigned
  
  //Set bits/pins 1,2,3 as output in GPIODIR port F register
  GPIO_DIR = 0x0Eu;
  
  GPIO_DEN = 0x0Eu;       //Digital function register?
